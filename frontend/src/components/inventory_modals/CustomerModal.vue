<!-- src/components/customers/CustomerModal.vue -->
<template>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="customerName" v-model="form.name" type="text" class="form-control"
                                    :class="{ 'is-invalid': errors.name }" placeholder="Enter customer name" required>
